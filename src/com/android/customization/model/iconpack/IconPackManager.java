...
public class IconPackManager implements CustomizationManager<IconPackOption> {
    ...
    private final LauncherIconPackProvider mProvider;
    private final ThemesUserEventLogger mEventLogger;

    public IconPackManager(IconPackProvider provider, ThemesUserEventLogger logger) {
        mProvider = provider;
        mEventLogger = logger;
    }
    ...
    public boolean isAvailable() {
        return mProvider.areIconPacksAvailable();
    }
