...
public class IconPackSectionController implements CustomizationSectionController<IconPackSectionView> {
    ...
    public class IconSectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class IconOptionsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            OptionSelectorController<IconPackOption> optionSelectorController = new OptionSelectorController<>((RecyclerView) view, mIconPacks, false, OptionSelectorController.CheckmarkStyle.CORNER);
            optionSelectorController.initOptions(mIconPackOptionsManager);
            for (IconPackOption option : mIconPacks) {
                if (option.isActive(mIconPackOptionsManager)) {
                    optionSelectorController.setSelectedOption(option);
                    break;
                }
            }
            optionSelectorController.addListener(new OptionSelectedListener() {
                @Override
                public void onOptionSelected(CustomizationOption selected) {
                    mIconPackOptionsManager.apply((IconPackOption) selected, mApplyIconCallback);
                    optionSelectorController.setAppliedOption((IconPackOption) selected);
                }
            });
        }
