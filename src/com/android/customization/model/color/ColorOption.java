...
public abstract class ColorOption implements CustomizationOption<ColorOption> {
    ...
    public ColorOption(String title, Map<String, String> settings, boolean isDefault, int position) {
        mTitle = title;
    ...
    private JSONObject getJsonPackages(boolean insertTimestamp) {
        ...
        if (mIsDefault) {
            ...
            JSONObject jSONObject2 = new JSONObject(mSettings);
    ...
    public boolean isActive(CustomizationManager<ColorOption> customizationManager) {
        ...
        return (TextUtils.isEmpty(currentColorSource) || getSource().equals(currentColorSource)) && mSettings.equals(map);
    }
}
